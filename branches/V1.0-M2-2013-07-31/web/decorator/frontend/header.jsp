                    ...
                    <c:choose>
                        <c:when test="${!empty basket}">
                            <span id="item_num" class="basket-items-count"
                                  style="padding: 0 0px 0 1px; font: bold 32px Arial;"><%=((Basket) session.getAttribute(Constant.BASKET)).getNumberOfItems()%></span>
                                    <span>
                                        <bean:message key="label.page.basket.items"/>
                                    </span>
                        </c:when>
                        <c:otherwise>
                            <span class="basket-items-count"
                                  style="padding: 0 5px 0 5px; font: bold 32px Arial;">0</span>
                                    <span>
                                        <bean:message key="label.page.basket.items"/>
                                    </span>
                        </c:otherwise>
        ...
        <ul id="header_links">
            ...
            <logic:present name="<%=Constant.USER_TRANSIENT%>">
                ...
                <li style="color: #EBC000;font: 12px Arial;text-decoration: none;text-transform: capitalize; margin-left:14px; display:inline;">
                    <bean:message key="lable.page.basket.welcome"/> <%=userName%>
                </li>
            ...
            <%--<li><a href="<%=context%>/frontend.do?operation=goToRegistrationPage"><bean:message key="label.page.title.register" /></a></li>--%>
            <%--<li><a href="javascript: void(0);" style="background-color:#ff66ff;" onclick="showBasket();">Show Basket</a> </li>--%>
            <%--<li><a href="javascript: void(0);" style="background-color:#ff66ff;" onclick="invalidateCurrentSession();">Invalidate Session</a></li>--%>
            <%--<li><a href="javascript: void(0);" style="background-color:#ff66ff;" onclick="showBasketSingleInCombinedInSession()();">Show Session</a></li>--%>
            <%--<li><a href="javascript: void(0);" style="background-color:#ff66ff;" onclick="showSessionItemNums()();">session items & price</a></li>--%>
