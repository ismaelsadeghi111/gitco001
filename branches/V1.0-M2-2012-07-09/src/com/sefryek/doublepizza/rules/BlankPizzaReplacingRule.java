...
public class BlankPizzaReplacingRule {
    ...
    public Boolean allDefaultToppingsIsSelected(){
    ...
    public BasketSingleItem create(){
    ...
    public BasketSingleItem checkRule(){
        if (menuSingleItem.isPizza()){
            Boolean allDefaultToppingsSelected = allDefaultToppingsIsSelected();
            boolean needToReplaceBlankPizza = allDefaultToppingsSelected != null && !allDefaultToppingsSelected;
