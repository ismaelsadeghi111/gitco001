...
public interface Constant {
    ...
    public static final Double DEFAULT_SERVICE_COST = 1.00;

    public static final String MAIL_SENDER_USER_NAME = "noreply@doublepizza.ca";
    public static final String MAIL_SENDER_PASSWORD = "toaCR0evvi!!*m9#@Ztd";

    public static final String MAIL_SENDER_BEAN_NAME = "mailSender";
    public static final String FREE_MARKER_CONFIG_NAME = "freemarkerConfiguration";

    public static final String ITEM_KIND_ = "";
    ...
    public final static String RUN_CAMPAIGN = "run";
    public final static String PAUSE_CAMPAIGN = "pause";
    public final static String SENDING_CAMPAIGN = "sending";
    ...
    public final static String MENUITEM_ISREDEEMABLE = "isRedeemable";
    ...
    public final static String MODIFIER_ISREDEEMABLE = "isRedeemable";
    //keys
    ...
    public static final String IN_MEMORY_DATA_LOADR_CRON_EXPRESSION = "0 0 3 1/1 * ? *";


    public static final String SEND_CAMPAIGN_SERVICE_NAME = "SEND_CAMPAIGN_SERVICE_NAME";
    public static final String SEND_CAMPAIGN_USER_SERVICE_NAME = "SEND_CAMPAIGN_USER_SERVICE_NAME";

    public static final String SEND_CAMPAIGN_MAIL_JOB_NAME = "SEND_CAMPAIGN_QUARTZ_JOB_NAME";
    public static final String SEND_CAMPAIGN_MAIL_TASK_NAME = "SEND_CAMPAIGN_QUARTZ_TASK_NAME";
    public static final String SEND_CAMPAIGN_MAIL_CRON_NAME = "SEND_CAMPAIGN_QUARTZ_NAME";
    public static final String SEND_CAMPAIGN_MAIL_CRON_EXPRESSION = "0 0/30 * 1/1 * ? *";
    ...
    public static final String LAST_SELECTED_ITEM = "lastSelectedItem";
    ...
    public static final String LAST_BASKET_SINGLE_IDENTIFIER = "lastBasketSingleIdentifier";
    public static final String SELECTED_BASKET_ITEM_IDENTIFIER = "selectedBasketItemIdentifier";
    public static final String LAST_BASKET_SINGLE_ITEM = "lastBasketSingleItem";
    ...
    public final static String ROLE_USER_TBL_NAME = "web_user_roles";
    ...
    public static final String BIRHDATE = "birthdate";
    public static final String USER_ISREGISTERED = "isRegistered";
    ...
    public final  static  String USER_ROLE_DESCRIPTION="user_role_description";
    public final  static  String USER_ROLE_ID="user_role_id";
    public final  static  String USER_ID_REF="user_id";
    public final  static  String ROLE_CREATE_DATE="user_role_date_created";
    public final  static  String ROLE_CEASED_DATE="user_role_date_ceased";
    ...
    //------ Web_header_his
    public final static String WEB_HEADER_HIS_TBL_NAME ="Web_Header_His";
    public final static String WEB_HEADER_HIS_Docnumber ="Docnumber";
    public final static String WEB_HEADER_HIS_TAKEOUT = "Takeout";
    public final static String WEB_HEADER_HIS_CUST = "Cust";
    public final static String WEB_HEADER_HIS_EXT = "Ext";
    public final static String WEB_HEADER_HIS_TODAYDATE = "Todaydate";
    public final static String WEB_HEADER_HIS_STORE = "Store";
    public final static String WEB_HEADER_HIS_TOTAL = "Total";
    public final static String WEB_HEADER_HIS_DISCOUNTDESC = "DiscountDesc";
    public final static String WEB_HEADER_HIS_DISCOUNT = "Discount";
    public final static String WEB_HEADER_HIS_DOCNUMBERORG = "Docnumberorg";
    public final static String WEB_HEADER_HIS_DOCTYPE = "Doctype";
    public final static String WEB_HEADER_HIS_DAYNO = "Dayno";
    public final static String WEB_HEADER_HIS_STOREOUT = "Storeout";
    public final static String WEB_HEADER_HIS_PDATE = "Pdate";
    ...
    public final static String DATA_RESOURCES_CAMPAIGN_PATH = "campaign";
    ...
    public final static String DATA_RESOURCES_QMENU_PATH = "qmenu";
    ...
    public final static String DP_DOLLARSCHADULE_TBL_NAME = "dpdollarschadule";
    public final static String DP_DOLLAR_TBL_NAME = "dpdollarday";

    public final static String SUGGESTIONS_MENUSINGLE_PRODUCTNO = "7777";
    public final static int MENUITEM_PRODUCTNO_DIGITS = 4;

    public final static int COMBINED_2_PIZZA = 2;
    public final static String DP_CATERING_TBL_NAME = "catering";
    //DpDevice
    public final static String APP_VERSION = "2.0";

    public final static int TOPPING_CATEGORY_SIZE = 6;
}
