...
public class MenuServiceImpl implements IMenuService {
    ...
    public List<Category> getMenuCategoryList(List<Map<String, Object>> webCategories) throws ServiceException {
        ...
        try {
            ...
            List<Map<String, Object>> webCategoriesTable = webCategories;
            InMemoryData.log = "";
            ...
            for (Map<String, Object> tblRow : webCategoriesTable) {
                ...
                try {
                    ...
                    isRedeemable = (Boolean) tblRow.get(Constant.MENUITEM_ISREDEEMABLE);
                ...
                if (categoryId != null && !categoryId.toString().equals("")) {
                    ...
                    Category category = new Category(
                            ...
                            tblRow.get(Constant.WEBCATEGORIES_PICTURE).toString(),isRedeemable);
...
//======================================================================================================
                 /*   for (SubCategory subCategoryItem : subCategories) {
                        if (subCategoryItem.getType().equals(MenuSingleItem.class)){
                            ((MenuSingleItem) subCategoryItem.getObject()).setIsRedeemable(isRedeemable);
                        } else if (subCategoryItem.getType().equals(CombinedMenuItem.class)){
                            ((CombinedMenuItem) subCategoryItem.getObject()).setIsRedeemable(isRedeemable);
                        }
                    }*/
//===========================================================================================================
    ...
    public List<PopularCategory> getMenuCategoryListByName(String foodName,String fromDate,String toDate) throws ServiceException {
        ...
        try {
//            return getMenuCategoryList(menuDAO.loadWebCategoriesByDateTable(fromDate, toDate));
            return menuDAO.loadWebCategoriesByNameTable(foodName,fromDate,toDate);
    ...
    public List<Category> getSpecialMenuCategoryList(List<Map<String, Object>> termTBL) throws ServiceException {
        ...
        try {
            ...
            List<Map<String, Object>> table = termTBL;
            for (Map<String, Object> tblRow : table) {
                ...
                if (categoryId != null && !categoryId.toString().equals("")) {
                    ...
                    Category category = new Category(
                            ...
                            Integer.parseInt(Constant.SEQ_ALTERNATIVE),
                            tblRow.get(Constant.TERM_IMAGE).toString(),isRedeemable);
    ...
    public List<Category> getSpecialMenuCategoryListByDate() throws ServiceException {
        ...
        try {
            ...
            List<Map<String, Object>> table = menuDAO.loadTermTableByDate(null, null);
            for (Map<String, Object> tblRow : table) {
                        ...
                        if (isCombinedMenuItem(tblRow)) {
                            ...
                            CombinedMenuItem combinedMenuItem = new CombinedMenuItem(productNo.toString(),
                                    ...
                                    tblRow.get(Constant.MENUITEM_SEQUENCE) != null ?
                                            ...
                                            Integer.parseInt(Constant.SEQ_ALTERNATIVE),
                                    (preset || !noPrint), preset, (String) tblRow.get(Constant.MENUITEM_WEBIMAGE),isRedeemable);
                            ...
                            menuSingleItem.setIsRedeemable(isRedeemable);
                            ...
                            Category category = new Category(productNo.toString(), nameKey, descKey,
                                    ...
                                    tblRow.get(Constant.MENUITEM_WEBIMAGE).toString(),isRedeemable);
