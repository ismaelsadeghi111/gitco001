...
CREATE TABLE Coupons (
	...
	Couponname varchar(25) NULL DEFAULT NULL,
	Type varchar(25) NULL DEFAULT NULL,
	Amount int NULL DEFAULT NULL,
	Morethan MONEY NULL DEFAULT NULL,
	Catindex int NULL DEFAULT NULL,
	DateFrom varchar(8) NULL DEFAULT NULL,
	DateTo varchar(8) NULL DEFAULT NULL,
	Couponseq INT NULL DEFAULT NULL,
