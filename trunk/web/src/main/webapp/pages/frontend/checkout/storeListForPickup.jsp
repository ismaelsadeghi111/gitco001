...
<logic:iterate id="storeLocator" name="<%=Constant.STORE_LIST_PICKUP%>" indexId="counter">
    ...
    <li class="ajax_block_product">
        <div class="left_block">            
            <a class="product_img_link"><img class="store-img" src="<%=context%><%=middlePath%>${storeItem.imageUrl}" width="145" height="125" /></a>
        </div>
        ...
        <div class="right_block border-bottom">
            ...
            <span class="store-title">${storeItem.name}</span><br clear="both">
        ...
        <button type="button" class="red-btn2" onclick="showMap('${storeItem.storeId}','${storeItem.name}');" title="View"><bean:message key="store.loacator.button.title"/></button>
