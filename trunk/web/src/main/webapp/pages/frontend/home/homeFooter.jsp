...
<div id="footer_2">
    ...
    <div class="tfy">
        <ul>
            ...
            <li><a target="_blank" href="http://www.facebook.com/pages/Double-pizza/162092927142348" class="facebook"></a></li>
            <li><a target="_blank" href="https://twitter.com/DoublePizzaHQ" class="twitter"></a></li>
            <li><a target="_blank" href="http://www.youtube.com/user/Doublepizzamtl" class="youtube"></a></li>
            <li><a target="_blank" href="http://itunes.apple.com/us/app/doublepizza/id527593994?mt=8" class="available"></a></li>
