...
<div id="columns2">
    ...
    <div id="center_column" class="center_column">
        <div id="center_column_inner2">
            <div class="rte">
                <h5><bean:message key="franchising.body.title" /></h5>
                <li class="static_page_content">
                    <img class="static_page_image" src="<%=request.getContextPath()%>/img/franchising.png" alt="doublepizza"/>
                    <bean:message key="franchising.body.content" />
                </li>
