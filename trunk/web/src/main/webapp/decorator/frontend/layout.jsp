...
<head >
    ...
    <%--google Map--%>
    <%--<script type="text/javascript" src="<%=context%>/js/jquery/_js/jquery-1.3.2.min.js"></script>--%>
    <script type="text/javascript" src="<%=context%>/js/jquery-ui-1.7.2.custom.min.js"></script>
    <script type="text/javascript" src="<%=context%>/js/jquery.lavalamp.1.3.2-min.js"></script>
    <link rel="stylesheet" type="text/css" href="<%=context%>/css/jquery-ui-1.7.1.custom.css"/>
